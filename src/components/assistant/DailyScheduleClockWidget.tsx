    ...
    <div className="my-3 p-4 bg-white border border-teal-200 rounded-2xl shadow-xs space-y-3">
      <div className="flex items-center justify-between">
        <div className="flex items-center gap-2">
          <span className="text-teal-800 font-bold text-xs">⏰ Daily Chronological Medication Clock</span>
          ...
          return (
            <div key={idx} className="relative group">
              ...
              >
                <div>
                  <div className="flex items-center gap-2">
                    <span className="text-xs">{getPeriodIcon(slot.period)}</span>
                  ...
                  <p className="text-[11px] text-ink-600 mt-1 flex items-center gap-1.5">
                    <span className="font-medium text-teal-800">🍽️ {slot.mealRelation}</span>
