...
export function MedicineIcon({ size = 24, className = '', ...props }: IconProps) {
  return (
    <svg
      width={size}
      height={size}
...
export function EmergencyAmbulanceIcon({ size = 24, className = '', ...props }: IconProps) {
  return (
    <svg
      width={size}
      height={size}
...
export function FileTextIcon({ size = 24, className = '', ...props }: IconProps) {
  return (
    <svg
      width={size}
      height={size}
...
export function EmptyIllustration({ className = '' }: { className?: string }) {
  return (
    <svg
      ...
      aria-hidden="true"
    >
      <rect x="25" y="15" width="90" height="90" rx="16" fill="var(--color-ink-100)" />
      <rect x="35" y="25" width="70" height="70" rx="12" fill="white" stroke="var(--color-ink-200)" strokeWidth="1.5" />
      <path d="M70 45V75M55 60H85" stroke="var(--color-brand-500)" strokeWidth="3.5" strokeLinecap="round" opacity="0.6" />
      <circle cx="70" cy="60" r="18" stroke="var(--color-brand-200)" strokeWidth="1.5" strokeDasharray="3 3" />
    </svg>
  );
}
